package weka.classifier.functions;//
...
import weka.classifiers.RandomizableClassifiers;
import weka.core.*;
...
public class LibSVMs extends RandomizableClassifiers implements TechnicalInformationHandler,Classifier {
...
//
    ...
    public void setOptions(String[] options) throws Exception {
        ...
        if(seedString.length() > 0) {
            this.setSeed(Integer.parseInt(seedString.trim()));
        }
    ...
    protected Object getProblem(Vector vx, Vector vy) {
        ...
        try {
            ...
            int e;
            for(e = 0; e < vy.size(); ++e) {
                this.setField(result, "x", e, vx.elementAt(e));
            }

            this.newArray(result, "y", Double.TYPE, vy.size());

            for(e = 0; e < vy.size(); ++e) {
                this.setField(result, "y", e, vy.elementAt(e));
            }
    ...
    public double[] distributionForInstance(Instance instance) throws Exception {
        ...
        if(!this.m_ProbabilityEstimates || this.m_SVMType != 0 && this.m_SVMType != 1) {
            v = ((Double)this.invokeMethod(Class.forName("libsvm.svm").newInstance(), "svm_predict", new Class[]{Class.forName("libsvm.svm_model"), Array.newInstance(Class.forName("libsvm.svm_node"), Array.getLength(x)).getClass()}, new Object[]{this.m_Model, x})).doubleValue();
            ...
            v = ((Double)this.invokeMethod(Class.forName("libsvm.svm").newInstance(), "svm_predict_probability", new Class[]{Class.forName("libsvm.svm_model"), Array.newInstance(Class.forName("libsvm.svm_node"), Array.getLength(x)).getClass(), Array.newInstance(Double.TYPE, prob_estimates.length).getClass()}, new Object[]{this.m_Model, x, prob_estimates})).doubleValue();
    ...
    public void buildClassifier(Instances insts) throws Exception {
        ...
        if(!isPresent()) {
            ...
            for(int error_msg = 0; error_msg < insts.numInstances(); ++error_msg) {
                Instance svmClass = insts.instance(error_msg);
                Object randF = this.instanceToArray(svmClass);
                int rand = Array.getLength(randF);
                if(rand > 0) {
                    max_index = Math.max(max_index, ((Integer)this.getField(Array.get(randF, rand - 1), "index")).intValue());
                }

                vx.addElement(randF);
                vy.addElement(new Double(svmClass.classValue()));
            }
            ...
            String var9 = (String)this.invokeMethod(Class.forName("libsvm.svm").newInstance(), "svm_check_parameter", new Class[]{Class.forName("libsvm.svm_problem"), Class.forName("libsvm.svm_parameter")}, new Object[]{this.getProblem(vx, vy), this.getParameters()});
            if(var9 != null) {
                throw new Exception("Error: " + var9);
            } else {
                Class var10 = Class.forName("libsvm.svm");
                java.lang.reflect.Field var11 = var10.getField("rand");
                Random var12 = (Random)var11.get((Object)null);
                var12.setSeed((long)this.m_Seed);
    ...
    public static void main(String[] args) {
        runClassifier(new LibSVMs(), args);
    }
